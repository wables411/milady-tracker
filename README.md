...
**No install:** open **https://wables411.github.io/milady-tracker** and
**Allow** the camera. (HTTPS, so it works on phones too. The mic is not
needed — the camera tracks your jaw.)
